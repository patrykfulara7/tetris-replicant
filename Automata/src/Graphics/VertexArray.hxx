...
namespace Automata
{
    ...
    public:
        ...
        inline const std::shared_ptr<VertexBuffer>& GetVertexBuffer() const { return vertexBuffer; }
        inline const std::shared_ptr<BufferLayout>& GetBufferLayout() const { return bufferLayout; }
        inline const std::shared_ptr<ElementBuffer>& GetElementBuffer() const { return elementBuffer; }
